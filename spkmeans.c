...
int main(int argc, char *argv[]) {
	int i, k;
	enum goal e;
	double ** data, **matrice_result;
	int data_length, features;
	...
	printArr(data, data_length, features);
	switch (e)
	{
	case wam:
		matrice_result = calcWAM(data, data_length, features);
		break;
	case ddg:
		break;
	case lnorm:
	...
	printArr(matrice_result, data_length, data_length);
